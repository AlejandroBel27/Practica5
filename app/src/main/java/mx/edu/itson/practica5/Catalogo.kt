...
class Catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Vidas Pasadas",R.drawable.vidaspasada,R.drawable.vidaspasadas,"Nora y Hae Sung, dos amigos de la infancia profundamente unidos, son separados después de que la familia de Nora emigrara de Corea del Sur. Veinte años después, se reúnen durante una fatídica semana para enfrentarse al amor y al destino.",arrayListOf<Cliente>()))
    }
    ...
    fun cargarSeries(){
        ...
        series.add(Pelicula("El Monstruo de la Vieja Seúl",R.drawable.el_monstruo,R.drawable.elmonstruovieja,"Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana.",arrayListOf<Cliente>()))
...
class PeliculaAdapter: BaseAdapter {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View? {
        ...
        image.setOnClickListener(){
            ...
            // Identificar si es película o serie para el contador
            if (peliculas == Catalogo.peliculas) {
                intento.putExtra("type", "movie")
            } else {
                intento.putExtra("type", "series")
            }
